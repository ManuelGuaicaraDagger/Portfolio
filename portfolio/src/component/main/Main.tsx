    ...
    return(
        <main className="px-[200px] flex justify-around">
            <div className="py-[200px]">
                ...
                <a href="/documents/ManuelGuaicara.pdf" download className="w-[175px] h-[35px] rounded-[10px]  flex justify-center items-center bg-pt-blue text-black font-bold">Descarga mi CV</a>
                </div>

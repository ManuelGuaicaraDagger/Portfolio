    ...
    return(
        <main className="px-[200px] flex justify-around max-[1100px]:px-[50px] max-[400px]:px-[10px]" id="sobre-mi">
            <div className="py-[200px] max-[600px]:py-[50px]">
                ...
                <h2 className="text-[48px] leading-none my-[20px] max-[1300px]:text-[32px] max-[700px]:text-[16px] max-[500px]:text-[8px] max-[500px]:my-[10px]">FullStack Developer</h2>
                ...
                <img src={lk} alt="LinkedIn Manuel Guaicara" className="h-[40px] mr-2 max-[500px]:h-[20px]"/>
                </a>
                <a href="https://github.com/ManuelGuaicaraDagger" target="_blank">
                <img src={gh} alt="Github Manuel Guaicara" className="h-[40px] max-[500px]:h-[20px]"/>
                </a>
                </div>
